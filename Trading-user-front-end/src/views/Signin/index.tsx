...
import { login, resendverificationstep, verifyotp } from 'services/webservices/user/api'
...
const Signin = () => {
  ...
  const {
    ...
    onSubmit: async (values1: any) => {
      ...
      if (response.responseMessage === "OTP sent to your register email address") {
        ...
        <div className="login-page">
          <div className="formoflogin">
            ...
            <form className="login-formoflogin" onSubmit={handleSubmit1}>
              ...
              <Link href="/ForgotPassword" className='forgotpasssword'> Forgot Password ?.</Link>
              <>
                <Modal
                  ...
                  <>
                    <ModalBody>
                      <form onSubmit={handleSubmit2}>
                        ...
                        ></input>
                        <br></br>
                        <p className='otpfont'> Otp Valid Till :- 00: {counter}</p>
                        <ModalFooter>
                          {counter === 0 && (<Button color="danger" type="submit" onClick={ResendOtp}>
                            Resend OTP
                          </Button>)}
